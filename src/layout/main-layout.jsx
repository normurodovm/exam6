...
export const MainLayout = () => {
  ...
  return (
    <div className="">
      <div className="flex gap-[100px] justify-start items-center pt-[69px] pb-[69px] container">
        <div className="container">
          <Header />
        </div>
        <div>
          <Link className=" font-[roboto] font-bold text-[20px]" to="/">
            home
          </Link>
        </div>
        <div>
          <Link className=" font-[roboto] font-bold text-[20px]" to="/about">
            about
          </Link>
        </div>
        <div>
          <Link className=" font-[roboto] font-bold text-[20px]" to="/shop">
            Shop
          </Link>
        </div>
        <div>
        ...
        <div className="flex items-center container">
          ...
          <div className="relative flex items-center">
            <input
              type="text"
              placeholder="Search..."
              className="px-4 py-2 w-64 rounded-full bg-gray-100 focus:outline-none focus:ring-2 focus:ring-green-500"
            />
